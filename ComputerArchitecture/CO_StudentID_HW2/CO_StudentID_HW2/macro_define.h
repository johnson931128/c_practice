...
#define macro_fft_cpu_time \
	fft_cpu_time = ( (double)fft_cycle_count * cycle_time );
...
#define macro_arraymul_baseline_cycle_count \
	arraymul_baseline_cycle_count = ( (long long)add_cnt * add_CPI + \
					  (long long)sub_cnt * sub_CPI + \
					  (long long)mul_cnt * mul_CPI + \
					  (long long)div_cnt * div_CPI + \
					  (long long)lw_cnt  * lw_CPI  + \
...
#define macro_arraymul_baseline_cpu_time \
	arraymul_baseline_cpu_time = ( (double)arraymul_baseline_cycle_count * cycle_time );

#define macro_calc_arraymul_baseline_ratio \
	arraymul_baseline_ratio = ( (arraymul_baseline_cycle_count > 0) ? \
				( \
				( (double)(arraymul_baseline_cycle_count - \
					( \
					(long long)lw_cnt * lw_CPI + \
					(long long)sw_cnt * sw_CPI + \
					(long long)flw_cnt * flw_CPI + \
